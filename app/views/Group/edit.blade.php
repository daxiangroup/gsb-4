...
<div class="page-header">
    <h2>{{ Lang::get('Group/strings.headers.edit') }}<br>
    <small>{{ Lang::get('Group/strings.subheaders.edit') }}</small></h2>
</div>

<p>{{ Lang::get('Group/intros.edit') }}</p>
...
<div class="row-fluid form-row">
    <div class="span4">
        {{ Form::label('group[buddies_approval]', Lang::get('Group/strings.labels.buddies_approval')) }}
    </div>
    <div class="span8">
        {{ Form::checkbox('group[buddies_approval]', $form_values['group_buddies_approval']['value'], $form_values['group_buddies_approval']['checked'], array('id'=>'group_buddies_approval')) }}
        <span class="field-explanation">{{ Lang::get('Group/strings.explanation.buddies_approval') }}</span>
    </div>
</div>
